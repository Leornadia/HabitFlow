            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  ...
                  <p className="mt-1 text-sm text-gray-600">Help us create AI technologies that represent and serve all communities fairly.</p>
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                  <h3 className="text-lg font-medium text-gray-900">Availability & work hours</h3>
                  <p className="mt-1 text-sm text-gray-600">Submit your availability for next week and check the hours you've clocked in the past few weeks.</p>
                  <button className="mt-3 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                    Update your hours
                  </button>
                </div>
